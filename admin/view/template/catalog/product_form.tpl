        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-links">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-label"><span data-toggle="tooltip" title="<?php echo $help_label; ?>"><?php echo $entry_label; ?></span></label>
                <div class="col-sm-10">
...
$('input[name=\'label\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/label/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
				json.unshift({
					label_id: 0,
